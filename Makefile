...
TASK_NAMES := task-1 pprof-1 pprof-2 pprof-template-1 pprof-fix-1 pprof-fix-2 pprof-fix-3 pprof-fix-4 pprof-fix-5 pprof-fix-6 pprof-audit-1 pprof-audit-2
...
.PHONY: help task-1 pprof-1 pprof-2 pprof-template-1 pprof-fix-1 pprof-fix-2 pprof-fix-3 pprof-fix-4 pprof-fix-5 pprof-fix-6 pprof-audit-1 pprof-audit-2 login docker-up docker-start docker-stop docker-down docker-restart docker-logs docker-ps
...
# Список её операций — в README.md.
#
...
help: ## этот список
	...
	@printf '  %-34s%s\n' \
		...
		'make pprof-1 republish ID'        'переписать тело уже опубликованной записи' \
