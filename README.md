...
- `internal/pipeline/` — общий движок обеих задач:
  ...
  - `articlefix/` — поток правки уже опубликованных статей целиком: разбор входа, репозиторий, правило переименования, `fetch → rewrite → update`. Общий у `pprof_fix_1`, `pprof_fix_2`, `pprof_fix_3`, `pprof_fix_4` и `pprof_fix_5`;
