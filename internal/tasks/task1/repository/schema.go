...
var expectedSchema = []schemaColumn{
	...
	{"article_inputs", "image_slug", "text", true},
	{"article_inputs", "meta_description", "text", true},
	{"article_inputs", "key_word", "text", true},
	{"article_inputs", "reference_url", "text", true},
	{"article_inputs", "author", "text", true},
	{"article_inputs", "links", "text", true},
	{"article_inputs", "professions", "text", true},
	{"article_inputs", "seo_title", "text", true},
	{"article_inputs", "profession_name", "text", true},
	{"article_inputs", "image_name", "text", true},
	{"article_inputs", "image_url", "text", true},
	...
	{"article_research", "collected_at", "timestamp with time zone", true},
	...
	{"article_metadata", "reading_time_minutes", "integer", true},
	{"article_metadata", "created_at", "timestamp with time zone", false},
	...
	{"article_outputs", "metadata_path", "text", true},
