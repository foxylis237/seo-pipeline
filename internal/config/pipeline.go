...
type PipelineConfig struct {
	...
	//
	// Ключ один на run и regenerate: пересоздание — тот же полный прогон, и отдельный
	// выключатель для него означал бы два ответа на один вопрос «выкладываем ли задачу».
