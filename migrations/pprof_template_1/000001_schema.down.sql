-- =============================================================================
-- Снос схемы pprof_template_1 целиком. Применяется только к схеме pprof_template_1.
--
-- Необратимо: вместе с таблицами уходят и статьи, и их состояние. Входные данные
-- восстанавливает повторный import из книги, всё остальное — новый прогон. У pprof_template_1 в
