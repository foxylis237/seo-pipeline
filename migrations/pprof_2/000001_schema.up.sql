...
--
-- article_path у pprof_2 — черновик основного промпта, fixed_article_path — страница после
-- ревью, и её читают разметка и result.md. review_path указывает на тот же файл, что и
-- fixed_article_path: списка замечаний ревью не отдаёт, отдельного текста у него нет.
-- Разойдутся они, когда вернётся SEO-редактура: её текст займёт review_path.
-- =============================================================================
